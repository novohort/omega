# Contributing to Github Template

## Links

## Table of Contents
- [Contributing to Github Template](#contributing-to-github-template)
  - [Links](#links)
...
If we fail to do so, please let us know.

If you see possible violations of the Code of Conduct please report them.
...
Submitting to `main` _requires_ commits to be GPG signed, and GPG signing of all commits is strongly recommended for _all_ pull requests.
...
When your first pull request is ready to be merged or if it is a simple enough change, please make sure you are listed in [`AUTHORS.md` under "Contributors"](AUTHORS.md#contributors).
